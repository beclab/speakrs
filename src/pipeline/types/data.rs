...
use super::score_aware::FrameSpeakerSupport;
...
pub struct DiarizationResult {
    ...
    /// Pre-binary overlap-added support for each global speaker cluster.
    pub frame_speaker_support: FrameSpeakerSupport,
